...
Create a file in `pages/grammar` with a filename that briefly describes your
guide in [kebab case][kebab-case]. For example, the path to this guide (the one
you're reading) is `pages/guides/how-to-create-a-guide.mdx`.
...
[markdown-cheatsheet]: https://grammarkup.vercel.app/guides/mdx-cheatsheet
...
[creating-a-pull-request]: https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/working-with-forks
