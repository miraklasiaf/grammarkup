...
<Callout mt={8}>
  Use articles _a_, _an_, _the_ to indicate whether the noun is used indefinitely or
  definitely.
</Callout>

- There is <Blank /> laptop, <Blank /> cup, <Blank /> open envelope, and <Blank /> pile of books on <Blank /> table. It is <Blank /> total mess. <Tooltip content="There is a laptop, a cup, an open envelope, and a pile of books on the table. It is a total mess." />

<Callout>
  Use demonstrative adjectives _this_, _that_, _these_, _those_ to indicate which specific
  person, place, or things is mentioned.
</Callout>

- <Blank /> shoes are quite nice. They'd go well with <Blank /> red dress.
  <Tooltip content="These/those, this/that" />

<Callout>
  Use numerals to limit the noun to a specific number or amount. Spot these numerals.
</Callout>

- Sorry, but we can't throw a party for one person. We should invite at least twenty people. <Tooltip content="one, twenty" />

<Callout>
  Use indefinite adjectives _any, each, few, many, much, most, several, some_ to describe
  a noun by showing an element of uncertainty. Spot these adjectives.
</Callout>

- The most important thing in the world is to be humane. <Tooltip content="most" />

<Callout>
  Do not confuse indefinite adjectives with indefinite pronouns. indefinite adjectives
  modify nouns or pronouns. indefinite pronouns are standalone pronouns.
</Callout>

- There are only **a few** people left. <Tooltip content="indefinite adjectives" />
- There are only **a few** left. <Tooltip content="indefinite pronouns" />
...
1. Do you live in <Blank /> house? - No, I live in <Blank /> apartment. <Tooltip content="a, an" />
2. <Blank /> weather was amazing last month. <Tooltip content="The" />
3. Ann didn't want to come in as there was <Blank /> dog in <Blank /> room. <Tooltip content="a, the" />
4. Would you like <Blank /> apple? <Tooltip content="an" />

**Fill in the gaps with _this_, _these_.**

1. Whose shoes are <Blank /> ? <Tooltip content="these" />
2. <Blank /> is a great coat. <Tooltip content="This" />
3. <Blank /> are our beloved sons. <Tooltip content="These" />

**Fill in the gaps with _some_, _any_.**

1. I got <Blank /> nice presents for you! <Tooltip content="some" />
2. She is too bossy so she doesn't have <Blank /> friends. <Tooltip content="any" />
3. There isn't <Blank /> juice left. <Tooltip content="any" />
