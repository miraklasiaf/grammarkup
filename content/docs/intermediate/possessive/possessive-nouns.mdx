...
<Callout mt={8}>To form possessive, add an apostrophe + _-s_ to the noun.</Callout>

- The (baby) <Blank /> clothes should be washed regularly. <Tooltip content="baby's" />

<Callout>If the noun already ends in _-s_, just add an apostrophe.</Callout>
...
<Callout>Use some of the fixed expressions where the possessive form is used.</Callout>
