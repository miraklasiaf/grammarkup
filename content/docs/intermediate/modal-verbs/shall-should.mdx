...
<Callout mt={8}>Use _shall_ to make offers or suggestions.</Callout>

- <Blank /> we buy cupcakes or one big cake? <Tooltip content="Shall" />

<Callout>Use _should_ to give advice, a recommendation, or a suggestion.</Callout>
...
<Callout>Use _should_ to express an obligation.</Callout>
