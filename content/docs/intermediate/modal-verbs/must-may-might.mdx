...
<Callout mt={8}>Use _must_ to express obligation, duty, or prohibition.</Callout>

- You <Blank /> gossip about your coworkers. <Tooltip content="mustn't" />

<Callout>Use _must_ to emphasize the necessity of something.</Callout>

- Kate <Blank /> go to the doctor. She looks ill. <Tooltip content="must" />

<Callout>Use _must_ to express certainty in something being true.</Callout>

- John didn't call me last night. He <Blank /> have been busy. <Tooltip content="must" />

<Callout>Use _may_ to ask for permission.</Callout>

- <Blank /> I open the curtains? It's quite dark here. <Tooltip content="May" />

<Callout>Use _may_ or _might_ to expressing possibility.</Callout>
