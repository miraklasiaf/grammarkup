...
<Callout type="success">
  Use the present form of _to be_ and the _-ing_ form of the main verb to make sentences
  in the present continuous.
</Callout>

- I (to fry) potatoes, my mom (to wash) the dishes, and my brothers (to wait) patiently for dinner to be ready. <Tooltip content="I am frying potatoes, my mom is washing the dishes, and my brothers are patiently waiting for dinner to be ready." />

<Callout type="success">
  Form question by inverting the subject and _to be_. Forms negatives with _to be_ + not.
  Use contracted forms.
</Callout>

- (it/to rain) outside? - No, it (not to rain). It's a bit cloudy but kids (to play) outside anyway. <Tooltip content="Is it raining outside? No, it isn't raining. It's a bit cloudy but kids are playing outside anyway." />

<Callout type="success">Find time markers.</Callout>

- Samantha is taking Chinese classes this year. She is studying a lot. <Tooltip content="this year" />

<Callout type="success">Use the present continuous to talk about changing situations.</Callout>

- The economic situation is already bad but it (to get) worse. <Tooltip content="The economic situation is already bad but it is getting worse." />
...
1. Be quiet! I `try`/`am trying` to concentrate. <Tooltip content="am trying" />

2. Sorry, I can't help you right now. I `be fixing`/`am fixing` my dad's computer. <Tooltip content="am fixing" />

3. It's very warm today. Why `you are`/`are you` wearing a coat? <Tooltip content="are you" />

**Complete each sentence with a suitable phrase.**

`beginning` · `becoming` · `doing` · `giving`

1. Don't disturb Ann. She is <Blank /> her taxes. <Tooltip content="doing" />

2. This is brilliant, isn't it? They're <Blank /> their best performance. <Tooltip content="giving" />

3. At first I didn't like my job but I'm <Blank /> to enjoy it. <Tooltip content="beginning" />

4. Ocean pollution is <Blank /> a real problem. <Tooltip content="becoming" />

**Answer the questions.**

1. What are you doing right now? <Tooltip content="I am doing my job right now" />

2. Is anything interesting happening in your country? <Tooltip content="There isn't anything interesting happening in my country now." />

3. Do you know what your family is doing now? <Tooltip content="My family is having a dinner party today." />
