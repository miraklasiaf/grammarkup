...
<Callout type="success">Use _can_/_could_ to ask for permission (informal/formal).</Callout>

- <Blank /> I go out side to play with friends? <Tooltip content="Can" />

<Callout type="success">Use _can_/_could_ to request something (informal/formal).</Callout>

- <Blank /> you spell your name, please? <Tooltip content="Could" />

<Callout type="success">Use _can_/_could_ to make offers or suggestions.</Callout>
