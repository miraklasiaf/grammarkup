...
<Callout>Subject pronouns replace nouns that are the subject of their clause.</Callout>
...
<Callout>Sometimes when we don't know the sex of a baby, we can use _it_.</Callout>

- The baby didn't sleep well. <Blank /> kicking all night. <Tooltip content='It was' />

<Callout>We use _it_ when we talk about time, weather, or temperature.</Callout>
