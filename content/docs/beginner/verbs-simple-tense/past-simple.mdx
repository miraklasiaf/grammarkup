...
<Callout>Use contracted forms to make negative sentences. (I'll, I'm etc.)</Callout>
...
<Callout>Use contracted forms to make negative sentences.</Callout>

- Jake (not to eat) tons of fast food as a kid. <Tooltip content="Jake didn't eat tons of fast food as a kid" />

<Callout>Make the correct form. Pay attention to spelling.</Callout>
...
<Callout>Use the past tense form of the verb _to be_</Callout>
