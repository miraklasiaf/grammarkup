...
<Callout type="success">
  Use the bare infinitive of the verb to make sentences in present simple. Add -_s_ in the
  third person singular.
</Callout>

- Agatha (to hate) when her little brothers (to leave) toys in the living room. <Tooltip content='Agatha hates when her little brothers leave toys in the living room' />

<Callout type="success">
  Add -_es_ in the third person singular if the verb ends in _o_, _s_, _ch_, _sh_, _x_.
</Callout>

- Noah (to wash) the dishes and his wife (to cook) dinner. <Tooltip content='Noah washes the dishes and his wife cooks dinner' />

<Callout type="success">Such verbs as _to be_ and _to have_ are irregular.</Callout>

- My mom's family (to be) quite big. She (to have) 4 brothers and 3 sisters. <Tooltip content="My mom's family is quite big. She has 4 brothers and 3 sisters" />

<Callout type="success">Form negatives by using do not/does not. Use contracted forms.</Callout>

- James (not to like) reading. I (not to get) how it is possible! <Tooltip content="James doesn't like reading. I don't get how it's possible!" />

<Callout type="success">Use the time markers.</Callout>

- (every day) People in Britain drink tea. <Tooltip content="People in Britain drink tea every day." />
- (always) The sun rises in the east. <Tooltip content="The sun always rises in the east." />
- (usually) She is tired after work. <Tooltip content="She is usually tired after work." />
...
1. Excuse me, `do you know`/`does you know` the time? <Tooltip content="do you know" />

2. My sister `always is`/`is always` in a hurry. <Tooltip content="is always" />

3. What time `you go`/`do you go` to bed on Fridays? <Tooltip content="do you go" />

**Write the correct answer**

1. Kelly (to stay/often) at home on Saturdays to work on her projects. <Tooltip content="Kelly often stays at home on Saturdays to work on her projects" />

2. Her brother (not to use) the Internet. He (to like) everything the old-fashioned way. <Tooltip content="Her brother doesn't use the Internet. He likes everything the old-fashioned way" />

3. When (you/to get) home? We need to talk. <Tooltip content="When do you get home? We need to talk" />

4. (you/to know) Lucy? She (to be) my friend from college. <Tooltip content="Do you know Lucy? She is my friends from college." />

**Answer the following question.**

1. What do you do for a living? <Tooltip content="I work as a software engineer." />

2. What are your hobbies? <Tooltip content="I like painting and reading. I sometimes go hiking" />

3. What does your typical Sunday look like? <Tooltip content="I wake up really late, have a big breakfast, and watch Netflix all day." />
