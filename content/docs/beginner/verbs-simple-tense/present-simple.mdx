...
<Callout>Such verbs as _to be_ and _to have_ are irregular.</Callout>
...
<Callout>Form negatives by using do not/does not. Use contracted forms.</Callout>
...
<Callout>Use the time markers.</Callout>
