...
<Callout type="success">Form questions by inverting the subject and _has/have_.</Callout>

- What (you/to do) lately? <Tooltip content="What have you been doing lately?" />

<Callout type="success">Form negatives by using _not_. Use contracted forms.</Callout>
