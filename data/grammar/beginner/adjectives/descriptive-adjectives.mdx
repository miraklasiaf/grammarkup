...
<Sidenote>
  Descriptive adjectives usually express things through the five senses (touch, taste, sight, smell,
  and sound). Spot these adjectives.
</Sidenote>
...
<Sidenote>
  ...
  material are expressed through simple adjectives. Spot these adjectives.
</Sidenote>
...
- Ann is an example of a girl next-door. She's sweet, kind, and has a lot in common with boys. <InfoTooltip label="next-door" />
...
1. If someone resembles a bird, he is <Blank /> <InfoTooltip label="bird-like" />

2. If someone broke your heart, you are <Blank /> <InfoTooltip label="broken-hearted" />

3. If you use your left hand to do everything, you are <Blank /> <InfoTooltip label="left-handed" />

**Put the adjectives into the correct order.**

1. Jim drew a picture of <Blank /> dragons. (`three-headed, two`) <InfoTooltip label="Jim drew a picture of two three-headed dragons." />

2. Jack bought a/an <Blank /> ring. (`diamond`, `expensive`, `engagement`) <InfoTooltip label="Jack bought an expensive diamond engagement ring." />

3. She was a <Blank /> lady. (`self-centered`, `young`) <InfoTooltip label="She was a self-centered young lady." />
